...
src/cr_osa/src/%.o: ../src/cr_osa/src/%.cpp
	...
	/usr/local/cuda-8.0/bin/nvcc -I../include -I../src/nvMedia -I../src/cr_osa/inc -I../src/encTrans -I/usr/include/opencv -I/usr/include/GL -I../src/capture -I../src/core -O3 -Xcompiler -fPIC -ccbin aarch64-linux-gnu-g++ -gencode arch=compute_50,code=sm_50 -m64 -odir "src/cr_osa/src" -M -o "$(@:%.o=%.d)" "$<"
